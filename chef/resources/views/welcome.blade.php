    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('/images/bg-01.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" id="mainForm">
<div id="error"></div>
...
<!--===============================================================================================-->
    ...
    <script src="/js/moveToHomePage.js"></script>
<!-- LOGIN REQUEST -->
<script>
  var TOKEN;
...
if(result['message']){$("#error").
    append('<div class="alert alert-warning alert-dismissible fade show" role="alert"><strong>ooops! </strong> '+result["message"]+'<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>')}
if(result["code"]=="USER001"){
